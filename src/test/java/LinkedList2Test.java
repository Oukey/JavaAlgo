...
public class LinkedList2Test {
    ...
    public void find() {
        ...
        list2.addInTail(new NodeL2(2));
        Assert.assertEquals(list2.find(2).value, 2);
        Assert.assertNotNull(list2.find(2));
        list2.addInTail(new NodeL2(1));
        list2.addInTail(new NodeL2(3));
        list2.addInTail(new NodeL2(3));
        list2.addInTail(new NodeL2(30));
    ...
    public void findAll() {
        ...
        list2.addInTail(new NodeL2(22));
        Assert.assertEquals(list2.findAll(22).size(), 1);
        list2.addInTail(new NodeL2(87));
        list2.addInTail(new NodeL2(87));
        list2.addInTail(new NodeL2(872));
    ...
    public void insertAfter() {
        LinkedList2 list2 = new LinkedList2();
        list2.insertAfter(null, new NodeL2(7));
        Assert.assertEquals(list2.head.value, 7);
        Assert.assertEquals(list2.count(), 1);
        list2.insertAfter(list2.head, new NodeL2(52));
        Assert.assertEquals(list2.count(), 2);
        Assert.assertEquals(list2.head.next.value, 52);
        list2.insertAfter(list2.tail, new NodeL2(100));
        Assert.assertEquals(list2.tail.value, 100);
        list2.insertAfter(list2.tail.prev, new NodeL2(24));
